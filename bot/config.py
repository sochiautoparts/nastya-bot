...
POLLINATIONS_MAX_TOKENS: int = 3000  # Full detailed responses - professional consultations need length!
...
- Здоровье: Аюрведа (доша-типы), психосоматика, конституция по группам крови, сезонные рекомендации
- Джйотиш: Ведическая астрология — Грахи, Раши, Бхавы, Накшатры, Дашы, Йоги, транзиты (Гочара)
