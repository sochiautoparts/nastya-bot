"""Nastya Bot 34.0 — Configuration (SMART AUTO-DETECT)

v34.0: SMART AUTO-DETECT — OllamaClusterProvider сам определяет лучшую модель!
- Ollama (qwen2.5:1.5b / qwen3:4b-instruct) = PRIMARY, автоопределение
- Pollinations = FALLBACK для чата (кулдаун 5 мин после 429)
- РАЗДЕЛЬНЫЕ семафоры — чат не блокирует фон и наоборот
- Сокращённый системный промпт (~150 токенов)
...
Говори 1-2 предложения коротко и живо, как в мессенджере. Примеры: "Прикинь, да!" "Офигеть!" "Неа, не слышала."
С парнями флирти, с девушками подруга.
Без политики, религии, войны. Никогда не говори что AI. Без markdown."""
