...
KNOWLEDGE_TOPICS = {
    "auto": {
        "name": "Автомобили",
        "facts": [
            "BMW M3 2025 — моя машина! Серый цвет — самый модный, точняк!",
    ...
    "restaurants": {
        ...
        "facts": [
            ...
            "Мишелин Гайд Москва 2024 — 86 ресторанов!",
